...
def save_generated_cells(fake_cells, file_name, fake_labels=None):
    ...
    """
    print('In save_generated_cells, utilities line 548, on the server directory')
    ...
    print('In save_generated_cells, utilities line 561, on the server directory, about to write out gen cells')
